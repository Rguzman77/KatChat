...
<div class="flex flex-col justify-center items-center w-[80vw] min-h-screen">
  ...
  <div class="mt-8 w-full">
    ...
    <form class="relative flex items-center" on:submit={handleSubmit}>
      <Input class="w-full h-[7vh] placeholder-neutral-950 pr-16" id="question" required placeholder="¿What is this text about? 🤔"></Input>
  ...
  {#if answer}
    <div bind:this={answerContainer} class="mt-8 mb-[15vh] py-4 px-2 rounded-md bg-white bg-opacity-30">
